...
(function($) {
    $.fn.goscalePluginsPicturesMini = function() {
	...
	plugins.goscalePluginsPicturesMini = function() {
		if($('.goscale-plugins-pictures.mini').length > 0) {
			$('.goscale-plugins-pictures.mini').goscalePluginsPicturesMini();
		}
	};
