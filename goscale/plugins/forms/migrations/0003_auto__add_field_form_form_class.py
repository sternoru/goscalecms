...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Form.form_class'
        db.add_column('cmsplugin_form', 'form_class',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Form.form_class'
    ...
    models = {
        ...
        'forms.form': {
            ...
            'form_class': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
