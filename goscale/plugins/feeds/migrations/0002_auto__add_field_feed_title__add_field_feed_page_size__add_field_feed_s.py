...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cmsplugin_feed', 'title',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Feed.page_size'
        db.add_column('cmsplugin_feed', 'page_size',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=10),
                      keep_default=False)

        # Adding field 'Feed.show_date'
        db.add_column('cmsplugin_feed', 'show_date',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Feed.page_size'
        db.delete_column('cmsplugin_feed', 'page_size')

        # Deleting field 'Feed.show_date'
    ...
    models = {
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 4, 0, 0)'}),
