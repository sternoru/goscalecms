...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field posts on 'Feed'
        db.create_table('feeds_feed_posts', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('feed', models.ForeignKey(orm['feeds.feed'], null=False)),
            ('post', models.ForeignKey(orm['goscale.post'], null=False))
        ))
        db.create_unique('feeds_feed_posts', ['feed_id', 'post_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field posts on 'Feed'
        db.delete_table('feeds_feed_posts')
