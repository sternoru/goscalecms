...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Picasa.width'
        db.add_column('cmsplugin_picasa', 'width',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Picasa.height'
        db.add_column('cmsplugin_picasa', 'height',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Picasa.thumbnail_width'
        db.add_column('cmsplugin_picasa', 'thumbnail_width',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Picasa.thumbnail_height'
        db.add_column('cmsplugin_picasa', 'thumbnail_height',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Picasa.autoplay'
        db.add_column('cmsplugin_picasa', 'autoplay',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Picasa.width'
        db.delete_column('cmsplugin_picasa', 'width')

        # Deleting field 'Picasa.height'
        db.delete_column('cmsplugin_picasa', 'height')

        # Deleting field 'Picasa.thumbnail_width'
        db.delete_column('cmsplugin_picasa', 'thumbnail_width')

        # Deleting field 'Picasa.thumbnail_height'
        db.delete_column('cmsplugin_picasa', 'thumbnail_height')

        # Deleting field 'Picasa.autoplay'
    ...
    models = {
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 9, 0, 0)'}),
