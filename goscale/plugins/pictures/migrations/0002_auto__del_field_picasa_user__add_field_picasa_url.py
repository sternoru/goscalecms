...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Picasa.user'
        db.delete_column('cmsplugin_picasa', 'user')

        # Adding field 'Picasa.url'
        db.add_column('cmsplugin_picasa', 'url',
                      self.gf('django.db.models.fields.CharField')(default='https://plus.google.com/photos/114610201247248895941/albums/5319044261264143137', max_length=250),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Picasa.user'
        raise RuntimeError("Cannot reverse this migration. 'Picasa.user' and its values cannot be restored.")
        # Deleting field 'Picasa.url'
    ...
    models = {
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 8, 0, 0)'}),
