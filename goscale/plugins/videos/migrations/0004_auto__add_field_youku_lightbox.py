...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'YouKu.lightbox'
        db.add_column('cmsplugin_youku', 'lightbox',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'YouKu.lightbox'
    ...
    models = {
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 10, 0, 0)'}),
