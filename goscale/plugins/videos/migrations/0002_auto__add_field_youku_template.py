...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'YouKu.template'
        db.add_column('cmsplugin_youku', 'template',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'YouKu.template'
    ...
    models = {
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 3, 0, 0)'}),
        ...
        'videos.youku': {
            ...
            'playlist': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
            'posts': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'plugins'", 'symmetrical': 'False', 'to': "orm['goscale.Post']"}),
